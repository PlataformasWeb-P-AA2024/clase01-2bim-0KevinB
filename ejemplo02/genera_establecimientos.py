...
for linea in lineas:
    ...
    # Establecimiento 936 y 1046 incorrecto: 

    # Código AMIE |Nombre de la Institución Educativa                                          |Código División Política Administrativa Provincia |Provincia   |Código División Política Administrativa  Cantón |Cantón                     |Código División Política Administrativa  Parroquia |Parroquia                                                |Zona Administrativa |Denominación del Distrito                         |Código de Distrito |Código de Circuito Educativo |Sostenimiento |Régimen Escolar |Jurisdicción |Tipo de Educación   |Modalidad                   |Jornada               |Nivel                                   |Etnia    |Acceso (terrestre/ aéreo/fluvial) |Número de estudiantes |Número de docentes |Estado |
